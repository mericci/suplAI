/**
 * HTTP handler: PATCH /api/organizations/:orgId/nominas/:id/pay (Edge Function)
 *
 * Admin only. Accepts multipart/form-data with a `file` field.
 */

import { payNomina } from '../handlers/index.ts';
import { AmountMismatchError } from '../actions/pay-nomina.ts';
