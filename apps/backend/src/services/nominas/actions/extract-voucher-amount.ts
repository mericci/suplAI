/**
 * Extract Voucher Amount Action
 *
 * Accepts a payment receipt file (PDF or image), sends it to Claude API,
 * and extracts the total transfer amount in CLP.
 */

import { logger } from '../../../utils/logger.js';
import { getErrorMessage } from '../../../utils/error.js';
import { callAnthropicMessages, anthropicModels } from '../../../commons/integrations/anthropic/index.js';
import { extractVoucherAmountPrompt } from '../prompts/index.js';
