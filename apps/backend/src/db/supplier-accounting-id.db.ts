/**
 * Supplier Accounting ID Database Queries
 *
 * Data access layer for supplier_accounting_ids operations.
...
/**
 * Find all active supplier-accounting-id links for a supplier in an org,
 * joined with accounting ID external_id and description.
 */
 ...
 * Soft-deletes existing rows, then inserts new ones.
 */
...
/**
 * Soft-delete a single supplier-accounting-id link.
 */
